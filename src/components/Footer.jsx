            ...
            <div className="container mx-auto px-4">
                <div className="grid md:grid-cols-3 gap-8 mb-8">
                    ...
                    <div className="flex items-start justify-between gap-4">
                        ...
                        <a href="https://www.linkedin.com/in/faruk-özdemir-5271a7172/" target="_blank" rel="noopener noreferrer" className="mt-8">
                            <img src="./linkedin-logo.jpg" alt="LinkedIn Profil" className="h-10 w-auto hover:opacity-80 transition-opacity" />
                        </a>
                    </div>
