            ...
            <div className="container mx-auto px-4">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <p className="mt-6 text-lg text-gray-600 leading-relaxed font-extralight">
                        Mit über 25 Jahren Erfahrung analysiere ich bestehende Planungen und Leistungsverzeichnisse, entwickle sie fachlich weiter und arbeite sie anschließend aktiv aus – von der technischen Prüfung bis zur belastbaren Ausschreibung. Bei Großprojekten biete ich darüber hinaus eine technische Unterstützung während der Bauphase an. Der Fokus liegt hierbei auf der <span className="font-light">Kostengruppe 300</span>, insbesondere zur Entlastung der Projektteams.
                    </p>
                    <p className="mt-6 text-lg text-gray-600 leading-relaxed font-extralight">
